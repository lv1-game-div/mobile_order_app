...
<body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
        ...
        <div class="carousel-inner relative overflow-hidden w-full">
            ...
            <div class="carousel-item absolute opacity-0" style="height:50vh;">
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right"
                    style="background-image: url('https://cdn.discordapp.com/attachments/1008571121743962212/1089133537149599765/kei_devedeve_McDonalds_hamburger_e18dcbf7-a180-404b-bf5c-89bd8b1f6c25.png');">

                    <div class="container mx-auto">
                        <div
                            class="flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide">
                            <p class="text-black text-2xl my-4 font-bold">ハンバーガー</p>
            ...
            <div class="carousel-item absolute opacity-0 bg-cover bg-right" style="height:50vh;">
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right"
                    style="background-image: url('https://cdn.discordapp.com/attachments/1008571121743962212/1089135560808996874/kei_devedeve_Hawaiian_Hamburger_ff8c80bd-3de3-4ea8-ad67-f0efda9f6c95.png');">

                    <div class="container mx-auto">
                        <div
                            class="flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide">
                            <p class="text-black text-2xl my-4 font-bold">ハワイアン ハンバーガー</p>
                            <a class="text-xl inline-block no-underline border-b border-gray-600 leading-relaxed hover:text-black hover:border-black"
                                href="#">view product</a>
                        </div>
                    </div>
            ...
            <div class="carousel-item absolute opacity-0" style="height:50vh;">
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-bottom"
                    style="background-image: url('https://cdn.discordapp.com/attachments/1008571121743962212/1089139017276194866/kei_devedeve_Hot_Chili_Hamburger_3c3d95eb-c8f3-4bf2-82ab-b3678cbb2405.png');">

                    <div class="container mx-auto">
                        <div
                            class="flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide">
                            <p class="text-white text-2xl my-4 font-bold">ホットチリ ハンバーガー</p>
                            <a class="text-xl inline-block no-underline border-b border-gray-600 leading-relaxed hover:text-black hover:border-black"
                                href="#">view product</a>
                        </div>
                    </div>
    ...
    <section class="bg-white py-8">
        ...
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            <div x-data="{ showModal: false, product: { name: '', price: '' } }">
                @for ($i = 0; $i < 5; $i++)
                    <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                        <a href="#"
                            x-on:click.prevent="$dispatch('purchase-modal', { productName: 'ハンバーガー', productPrice: 400 })">
                            <img class="hover:grow hover:shadow-lg"
                                src="https://cdn.discordapp.com/attachments/1008571121743962212/1089145981888634991/kei_devedeve_White_Background_Juicy_Cheddar_Cheeseburger_a746c0c8-c3ce-4161-82e5-f7d48875a1f4.png">
    ...
    <div x-data="{ total: 0, count: 0 }">
        <!-- ページのコンテンツ -->

        <!-- 追従フッターのコンポーネント -->
        <x-purchase-amount-footer />
    </div>
